<template>
  <el-select class="filter-item " style="margin-bottom: 0px;" :style="{height:height,width:width}" :size="size" clearable filterable :placeholder=placeholder v-model="coach"
