...
export const appMap = [
  ...
  { id: 90403, desktop: '1', type: '9', pid: 99999, params: [], name: '考试情况', content: _import('modules/newMenu/servicemanagement/storesoptions'), icon: getIcon('app_default'), msgCount: 0, childItem: [] },
