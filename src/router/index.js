...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      { menuId: 40400, path: 'increment', component: _import('modules/basis/increment/index'), name: '增值包设置', isShow: true, meta: { title: '增值包设置', icon: 'menu' }},
      { menuId: 40500, path: 'service-type', component: _import('modules/basis/service-type/index'), name: '服务类别设置', isShow: true, meta: { title: '服务类别设置', icon: 'menu' }},
