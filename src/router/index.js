...
export const appMap = [
  ...
  { id: 70203, desktop: '1', type: '5', pid: 70000, params: [], name: '测试', content: _import('modules/finance/aaa'), icon: getIcon('app_default'), msgCount: 0, childItem: [] },
  // 统计
 ...
 * @type {Array}
 */
export const anonList = [-1086, 10008, 10001, 30100, 21000, 70202, 70203]
/**
 * 添加
