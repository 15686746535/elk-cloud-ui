...
export const appMap = [
  ...
  { id: 20101, desktop: '1', type: '1', pid: 20100, params: { display: 'add' }, name: '学员添加', content: _import('modules/stu/student'), icon: getIcon('app_stu_student'), msgCount: 0, childItem: [] },
  ...
  { id: 80100, desktop: '1', type: '1', pid: 20000, params: [], name: '约车信息', content: _import('modules/bespeak/vehiclePeriod'), icon: getIcon('app_vehiclePeriod'), msgCount: 0, childItem: [] },
  // 客户
  { id: 30200, desktop: '1', type: '2', pid: 30000, params: [], name: '意向信息', content: _import('modules/visit/intention'), icon: getIcon('app_visit_intention'), msgCount: 0, childItem: [] },
  { id: 30201, desktop: '1', type: '2', pid: 30200, params: [], name: '意向添加', content: _import('modules/visit/intention'), icon: getIcon('app_visit_intention'), msgCount: 0, childItem: [] },
  ...
  // 财务
  { id: 70100, desktop: '1', type: '5', pid: 70000, params: [], name: '费用信息', content: _import('modules/finance/costNote'), icon: getIcon('app_costInfo'), msgCount: 0, childItem: [] },
  // 统计
  { id: 120600, desktop: '1', type: '6', pid: 80000, params: [], name: '月招统计', content: _import('modules/visualization/recruit'), icon: getIcon('app_recruit'), msgCount: 0, childItem: [] },
  ...
  { id: 120200, desktop: '1', type: '6', pid: 80000, params: [], name: '招生点数', content: _import('modules/visualization/enrolSite'), icon: getIcon('app_enrolSite'), msgCount: 0, childItem: [] },
  { id: 120500, desktop: '1', type: '6', pid: 80000, params: [], name: '来源渠道', content: _import('modules/visualization/source'), icon: getIcon('app_source'), msgCount: 0, childItem: [] },
  { id: 120300, desktop: '1', type: '6', pid: 80000, params: [], name: '在培学员', content: _import('modules/visualization/subject'), icon: getIcon('app_subject'), msgCount: 0, childItem: [] },
  // 基础配置
  ...
  { id: 40300, desktop: '1', type: '7', pid: 90000, params: [], name: '报名点设置', content: _import('modules/basis/enrollDot'), icon: getIcon('app_enroll'), msgCount: 0, childItem: [] },
  ...
  { id: 40600, desktop: '1', type: '7', pid: 90000, params: [], name: '回访问题', content: _import('modules/basis/revisitQuestion'), icon: getIcon('app_question'), msgCount: 0, childItem: [] },
  { id: 40700, desktop: '1', type: '7', pid: 90000, params: [], name: '来源渠道', content: _import('modules/basis/source'), icon: getIcon('app_sourcetype'), msgCount: 0, childItem: [] },
  { id: 40900, desktop: '1', type: '7', pid: 90000, params: [], name: '顾虑问题', content: _import('modules/basis/worry'), icon: getIcon('app_worrytype'), msgCount: 0, childItem: [] },
  { id: 41000, desktop: '1', type: '7', pid: 90000, params: [], name: '考场管理', content: _import('modules/basis/examDot'), icon: getIcon('app_examdot'), msgCount: 0, childItem: [] },
  { id: 41200, desktop: '1', type: '7', pid: 90000, params: [], name: '训练场管理', content: _import('modules/basis/trainingDot'), icon: getIcon('app_training'), msgCount: 0, childItem: [] },
  { id: 41300, desktop: '1', type: '7', pid: 90000, params: [], name: '客户类型', content: _import('modules/basis/customerType'), icon: getIcon('app_customerType'), msgCount: 0, childItem: [] },
  // 日志
