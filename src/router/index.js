...
export const appMap = [
  ...
  { id: 20600, desktop: '1', pid: 20000, params: [], name: '毕业学员', content: _import('modules/stu/graduation'), icon: getIcon('app_stu_graduation'), msgCount: 0, childItem: [] },
  { id: 20700, desktop: '1', pid: 20000, params: [], name: '学员回访', content: _import('modules/stu/revisit'), icon: getIcon('app_stu_revisit'), msgCount: 0, childItem: [] },
  { id: 20800, desktop: '1', pid: 20000, params: [], name: '回访信息', content: _import('modules/stu/revisited'), icon: getIcon('app_stu_revisited'), msgCount: 0, childItem: [] },
  { id: 30200, desktop: '1', pid: 30000, params: [], name: '意向信息', content: _import('modules/visit/intention'), icon: getIcon('app_visit_intention'), msgCount: 0, childItem: [] },
  { id: 30201, desktop: '1', pid: 30200, params: [], name: '意向添加', content: _import('modules/visit/intention'), icon: getIcon('app_visit_intention'), msgCount: 0, childItem: [] },
  { id: 30100, desktop: '1', pid: 30000, params: [], name: '意向分配', content: _import('modules/visit/distribution'), icon: getIcon('app_visit_distribution'), msgCount: 0, childItem: [] },
  { id: 30300, desktop: '1', pid: 30000, params: [], name: '入学意向', content: _import('modules/visit/enrolled'), icon: getIcon('app_visit_enrolled'), msgCount: 0, childItem: [] },
  { id: 30400, desktop: '1', pid: 30000, params: [], name: '关闭意向', content: _import('modules/visit/close'), icon: getIcon('app_visit_close'), msgCount: 0, childItem: [] },
  { id: 50100, desktop: '1', pid: 50000, params: [], name: '车辆信息', content: _import('modules/vehicle/car'), icon: getIcon('app_car'), msgCount: 0, childItem: [] },
  // 人力资源
  { id: 60100, desktop: '1', pid: 60000, params: [], name: '同事信息', content: _import('modules/upms/user'), icon: getIcon('app_user'), msgCount: 0, childItem: [] },
  ...
  // 财务
  { id: 70100, desktop: '1', pid: 70000, params: [], name: '费用信息', content: _import('modules/finance/costNote'), icon: getIcon('app_costInfo'), msgCount: 0, childItem: [] },
  // 统计
  { id: 120600, desktop: '1', pid: 80000, params: [], name: '月招统计', content: _import('modules/visualization/recruit'), icon: getIcon('app_recruit'), msgCount: 0, childItem: [] },
  { id: 120100, desktop: '1', pid: 80000, params: [], name: '顾虑统计', content: _import('modules/visualization/worry'), icon: getIcon('app_worrycount'), msgCount: 0, childItem: [] },
  { id: 120400, desktop: '1', pid: 80000, params: [], name: '来访统计', content: _import('modules/visualization/intention'), icon: getIcon('app_intentioncount'), msgCount: 0, childItem: [] },
  { id: 120200, desktop: '1', pid: 80000, params: [], name: '招生点数', content: _import('modules/visualization/enrolSite'), icon: getIcon('app_enrolSite'), msgCount: 0, childItem: [] },
  { id: 120500, desktop: '1', pid: 80000, params: [], name: '来源渠道', content: _import('modules/visualization/source'), icon: getIcon('app_source'), msgCount: 0, childItem: [] },
  { id: 120300, desktop: '1', pid: 80000, params: [], name: '在培学员', content: _import('modules/visualization/subject'), icon: getIcon('app_subject'), msgCount: 0, childItem: [] },
  // 基础配置
  { id: 40100, desktop: '1', pid: 90000, params: [], name: '校区设置', content: _import('modules/basis/campus'), icon: getIcon('app_campus'), msgCount: 0, childItem: [] },
  { id: 40300, desktop: '1', pid: 90000, params: [], name: '报名点设置', content: _import('modules/basis/enrollDot'), icon: getIcon('app_enroll'), msgCount: 0, childItem: [] },
  { id: 40500, desktop: '1', pid: 90000, params: [], name: '收费设置', content: _import('modules/basis/serviceCategory'), icon: getIcon('app_service'), msgCount: 0, childItem: [] },
  { id: 40600, desktop: '1', pid: 90000, params: [], name: '回访问题', content: _import('modules/basis/revisitQuestion'), icon: getIcon('app_question'), msgCount: 0, childItem: [] },
  { id: 40700, desktop: '1', pid: 90000, params: [], name: '来源渠道', content: _import('modules/basis/source'), icon: getIcon('app_sourcetype'), msgCount: 0, childItem: [] },
  { id: 40900, desktop: '1', pid: 90000, params: [], name: '顾虑问题', content: _import('modules/basis/worry'), icon: getIcon('app_worrytype'), msgCount: 0, childItem: [] },
  { id: 41000, desktop: '1', pid: 90000, params: [], name: '考场管理', content: _import('modules/basis/examDot'), icon: getIcon('app_examdot'), msgCount: 0, childItem: [] },
  { id: 41200, desktop: '1', pid: 90000, params: [], name: '训练场管理', content: _import('modules/basis/trainingDot'), icon: getIcon('app_training'), msgCount: 0, childItem: [] },
  { id: 41300, desktop: '1', pid: 90000, params: [], name: '客户类型', content: _import('modules/basis/customerType'), icon: getIcon('app_customerType'), msgCount: 0, childItem: [] },
  // 日志
