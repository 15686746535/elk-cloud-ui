...
export const appMap = [
  ...
  { id: 90402, desktop: '1', type: '9', pid: 99999, params: [], name: '统计测试', content: _import('modules/visualization/view-amount-growth-rate'), icon: getIcon('app_default'), msgCount: 0, childItem: [] },
