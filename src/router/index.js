...
export const appMap = [
  ...
  { id: 90403, desktop: '1', type: '9', pid: 99999, params: [], name: '学员管理测试', content: _import('modules/newMenu/colleagues/colleagues-info'), icon: getIcon('app_default'), msgCount: 0, childItem: [] },
