<!--<template>-->
  <!--<div class="dashboard-container">-->
    ...
    <!--<el-row>-->
      ...
      <!--&lt;!&ndash;<input type="button" value="状态" @click="getStatus">&ndash;&gt;-->
      <!--<input type="button" value="读取" @click="readCert">-->
      <!--&lt;!&ndash;<input type="button" value="断开" @click="disconnect">-->
<!--&ndash;&gt;-->
   ...
   <!--&lt;!&ndash; <div style="height: 500px;float: left;width: 300px;" >-->
      <!--&lt;!&ndash; 调用实例  &ndash;&gt;-->
