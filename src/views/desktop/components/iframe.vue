...
-->
<template lang="html">
    <div :id="options.id" class="vl-notify vl-notify-main vl-notify-alert vl-notify-iframe"  @mousemove="move" @mouseup="moveEnd" @focus="resetZIndex" tabindex="1"
         :style="{left:options.offset[0] + 'px',top:options.offset[1] +'px', margin:options.offset[2],zIndex:zindex, width: width, height: height}">
        <h2 class="vl-notice-title" @mousedown="moveStart">{{options.title}}
