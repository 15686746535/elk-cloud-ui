<template xmlns:v-popover="http://www.w3.org/1999/xhtml">
  <div class="app-container calendar-list-container" :style="{height: $store.state.app.client.height + 'px'}">
    ...
    <el-card :style="{height: ($store.state.app.client.height - 40) + 'px'}">
      <el-table :key='tableKey' :data="list" v-loading="listLoading"  :height="$store.state.app.client.height-120"  element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%">
...
<script>
  ...
  export default {
    ...
    created() {
      this.getList()
      this.menu_add = this.permissions['basis_enroll_dot_add']
      this.menu_upd = this.permissions['basis_enroll_dot_update']
      this.menu_del = this.permissions['basis_enroll_dot_del']
    },
    methods: {
      getList() {
