<template xmlns:v-popover="http://www.w3.org/1999/xhtml">
  <div class="app-container calendar-list-container" :style="{height: client.height + 'px'}">
    ...
    <el-card :style="{height: (client.height - 40) + 'px'}">
      <el-table :key='tableKey' :data="list" v-loading="listLoading"  :style="{height: (client.height-120) + 'px'}"element-loading-text="给我一点时间" border fithighlight-current-row style="width: 100%">
