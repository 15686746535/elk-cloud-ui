    ...
    <!--<el-card style="height: 100%">-->
      <!--<div class="filter-container" >-->
        ...
        <!--<div style="height: 40px; float: right">-->
          ...
          <!--&lt;!&ndash;<el-button class="filter-item" type="primary"  @click="getDateList">搜索</el-button>&ndash;&gt;-->
        ...
        <!--<el-table-column type="expand">-->
          <!--<template slot-scope="props">-->
            <!--<el-row style="text-align: center">-->
              ...
              <!--</span>-->
            <!--</el-row>-->
            <!--&lt;!&ndash;<span style="margin-left: 5px;" v-for="student in props.row.studentList">&ndash;&gt;-->
              <!--&lt;!&ndash;<el-tag>&ndash;&gt;-->
                <!--&lt;!&ndash;{{student.name}}&nbsp;&nbsp;({{student.mobile}})&ndash;&gt;-->
              <!--&lt;!&ndash;</el-tag>&ndash;&gt;-->
            <!--&lt;!&ndash;</span>&ndash;&gt;-->
          <!--</template>-->
        <!--</el-table-column>-->
      ...
      <!--&lt;!&ndash;&ndash;&gt;-->
      <!--<el-dialog :modal="false" @close="cancel('carPeriod')" :close-on-click-modal="false" width="700px" title="编辑课时" :visible.sync="editOption">-->
        ...
        <!--<el-form :model="carPeriod" :rules="carPeriodRules"  ref="carPeriod" label-position="left" label-width="100px">-->
          ...
          <!--<el-row>-->
            ...
            <!--<el-row :gutter="20">-->
              <!--<el-col :span="12">-->
                <!--<el-form-item prop="coachId">-->
                  <!--<span slot="label" class="text_css"></span>-->
            ...
            <!--<el-row>-->
              <!--<el-form-item required>-->
                ...
                <!--</el-date-picker>-->
                <!--&lt;!&ndash;<el-date-picker value-format="timestamp" style="width: 100%;" v-model="carPeriod.interval" type="datetimerange" align="left" unlink-panels range-separator="—" start-placeholder="开始日期" end-placeholder="结束日期">&ndash;&gt;-->
      ...
      <!--<el-dialog :modal="false" :close-on-click-modal="false" @close="cancel('vehiclePeriod')" width="700px" title="录入课时" :visible.sync="addOption">-->
...
<!--<script>-->
  <!--import { getVehiclePeriodList, putVehiclePeriod, deleteVehiclePeriodStudent } from '@/api/bespeak/vehicleperiod'-->
