<template>
  <div class="app-container calendar-list-container" :style="{height: $store.state.app.client.height + 'px'}">
    ...
    <el-card :style="{height: ($store.state.app.client.height - 125) + 'px'}">
      <el-table :data="list" v-loading="listLoading" :height="($store.state.app.client.height-205)" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%">
