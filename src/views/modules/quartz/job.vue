<template>
  <div style="height: 100%">
    <el-card v-show="showModule=='list'" style="height: 100%">
      ...
      <el-table :data="list" v-loading="listLoading" :height="(tableHeight-215)" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%">
    ...
    <el-card v-show="showModule=='info'" >
      <!-- 这里手写 -->
