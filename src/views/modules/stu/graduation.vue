                  ...
                  <el-col style=" line-height: 25px">
                    ...
                    <el-row :gutter="10">
                      ...
                      <el-col :span="17" class="table_text">
                        <span v-for="(introducer,index) in scope.row.introducerList">{{introducer}}<span v-if="scope.row.introducerList.length !== (graduation+1)">、</span></span>
                      </el-col>
                    </el-row>
                  </el-col>
                </template>
                ...
                <template slot-scope="scope">
                  <el-col style=" line-height: 25px">
                    ...
                    <el-row :gutter="10">
                      ...
                      <el-col :span="17" class="table_text">
                        <span v-for="(increment,index) in scope.row.incrementList">{{increment}}<span v-if="scope.row.incrementList.length !== (graduation+1)">、</span></span>
                      </el-col>
                    </el-row>
                    ...
                    <el-col>
                      ...
                      <el-row>
                        ...
                        <el-form-item prop="introducerNameList">
                          ...
                          <span v-for="(introducerName,index) in student.introducerNameList">{{introducerName}}<span v-if="student.introducerNameList.length !== (graduation+1)">、</span></span>
                        </el-form-item>
                      </el-row>
                    </el-col>
                  </el-row>
