      ...
      <el-row :gutter="5">
        ...
        <el-col :style="{width: (client.width-250) + 'px'}" style="line-height: 50px">
          <el-card style="margin-bottom: 5px;height: 130px;">
              <div>
                <el-date-picker value-format="timestamp" v-model="listQuery.interval" type="daterange" align="left" unlink-panels range-separator="—" start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="pickerOptions">
                </el-date-picker>
