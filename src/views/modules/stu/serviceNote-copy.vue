  ...
  <!--<div class="app-container1 calendar-list-container1" :style1="{height: $store.state.app.client.height + 'px'}">-->
    <!--<el-card  style="height: 100%">-->
      <!--<div slot="header" class="clearfix">-->
        <!--<span>-->
          <!--&lt;!&ndash;<el-radio-group  @change="studentIdChange" v-model="flag">&ndash;&gt;-->
            <!--&lt;!&ndash;<el-radio-button :label="true">添加收费</el-radio-button>&ndash;&gt;-->
            <!--&lt;!&ndash;<el-radio-button :label="false">补齐费用</el-radio-button>&ndash;&gt;-->
  ...
  <!--export default {-->
    ...
    <!--methods: {-->
      ...
      <!--calculation() {-->
        ...
        <!--}-->
        <!--/* 再计算参加活动的价格 */-->
        <!--for (var a = 0; a < this.stuServiceBuyNoteEntity.financeList.length; a++) {-->
          <!--if (this.stuServiceBuyNoteEntity.financeList[a].code === '004') {-->
            <!--if (this.stuServiceBuyNoteEntity.financeList[a].priceType === '0') {-->
              <!--activityPrice = activityPrice + this.stuServiceBuyNoteEntity.financeList[a].price-->
            <!--} else {-->
              <!--activityPrice = activityPrice + (this.stuServiceBuyNoteEntity.financeList[a].price * this.stuServiceBuyNoteEntity.financeList[a].number)-->
            <!--}-->
          <!--}-->
        <!--}-->
      ...
      <!--actualMoneyCalculation() {-->
        ...
        <!--} else if (this.stuServiceBuyNoteEntity.receivablesType === '定转全') {-->
          ...
          <!--this.stuServiceBuyNoteEntity.realPrice = 0-->
          <!--other_m = 0.0-->
          <!--for (var n = 1; n < this.payTypeList.length; n++) {-->
            <!--if (this.payTypeList[n].money !== null && this.payTypeList[n].money !== 0 && this.payTypeList[n].money !== '') {-->
              <!--other_m += this.payTypeList[n].money-->
            <!--}-->
          <!--}-->
        ...
        <!--for (var a = 0; a < this.payTypeList.length; a++) {-->
          <!--if (this.payTypeList[a].money !== null && this.payTypeList[a].money !== 0 && this.payTypeList[a].money !== '') {-->
            <!--this.stuServiceBuyNoteEntity.payTypeList.push(this.payTypeList[a])-->
          <!--}-->
          <!--this.stuServiceBuyNoteEntity.realPrice = Number(this.stuServiceBuyNoteEntity.realPrice) + Number(this.payTypeList[a].money)-->
        <!--}-->
      <!--},-->
      <!--clean() {-->
        <!--this.payTypeList = [-->
