  ...
  <div class="student" style="height: 100%;">
    ...
    <div v-show="showModule=='list'" style="height: 100%">
      <el-card body-style="padding: 5px 20px;" style="margin-bottom: 5px;height: 90px;line-height: 38px">
        <el-row :gutter="5">
          <el-col :xs="6" :sm="6" :md="8" :lg="7" :xl="5">
            <el-date-picker value-format="timestamp" style="width: 100%" size="mini" v-model="listQuery.interval"
          ...
          <el-col :xs="6" :sm="6" :md="6" :lg="4" :xl="4">
            <el-select size="mini" style="width: 100%" v-model="listQuery.subject" clearable filterable
                       placeholder="科目">
              <el-option
          ...
          <!--</el-col>-->
          <el-col :xs="6" :sm="6" :md="6" :lg="4" :xl="4">
            <el-select style="width: 100%;" size="mini" v-model="listQuery.introducer" clearable filterable
                       placeholder="介绍人">
              <el-option
          ...
          <el-col :xs="6" :sm="6" :md="6" :lg="4" :xl="4">
            <el-input @keyup.enter.native="searchClick" size="mini" placeholder="姓名/电话/身份证"
                      v-model="listQuery.condition"></el-input>
          </el-col>
      ...
      <el-card :style="{height: tableHeight - 130 + 'px'}" id="student-table-card">
        <el-table :data="stuList" :height="tableHeight - 220" highlight-current-row stripe id="student-table"
                  @row-dblclick="editList" v-loading="listLoading" element-loading-text="给我一点时间">
        ...
        <div v-show="!listLoading" class="page-util">
          ...
          <el-button @click="create" size="small" style="float:right;margin: 0 30px" type="primary"
                     v-if="permissions.stu_student_add"><i class="el-icon-plus"></i>添加
          </el-button>
    ...
    <el-card v-show="showModule=='info'" style="height: 100%;overflow: auto;position: relative;">
      <el-button type="primary" :disabled="edit" size="mini" @click="returnClick"
                 style="position: absolute;top: 25px;right: 35px;z-index: 6666;"><i class="el-icon-back"></i> 返 回
      </el-button>
      <div style="position: absolute;top: 15px;left: 16px;z-index: 6666;">
        <el-upload :disabled="!edit" style="height: 50px;" class="avatar-uploader" action="/oss/upload" name="file"
                   :show-file-list="false" :headers="headers" accept=".png,.jpg"
      ...
      <el-row style="height: 100%;" :gutter="10">
        <el-col :span="area[1] === 600?24:12" style="padding-bottom: 30px">
          <el-form :model="student" :rules="studentRules" ref="student" label-position="left" label-width="80px"
                   size="mini">
                ...
                <el-col :span="12">
                  ...
                  <el-row>
                    <el-form-item prop="archivesNumber">
                      ...
                      <el-input v-if="edit" size="mini" class="filter-item" placeholder="档案号"
                                v-model="student.archivesNumber"></el-input>
                  ...
                  <el-row>
                    <el-form-item prop="name">
                      ...
                      <el-input v-if="edit" size="mini" class="filter-item" placeholder="姓名"
                  ...
                  <el-row>
                    <el-form-item prop="idNumber">
                      ...
                      <el-input v-if="edit" size="mini" class="filter-item" placeholder="身份证号" :maxlength="18"
                                @keyup.enter.native="generateInfo" @blur="generateInfo"
                                v-model="student.idNumber"></el-input>
                  ...
                  <el-row>
                    <el-form-item prop="birthday">
                      ...
                      <el-date-picker value-format="timestamp" v-if="edit" type="date" placeholder="生日"
                                      style="width: 100%" v-model="student.birthday"></el-date-picker>
                  ...
                  <el-row>
                    <el-form-item prop="contactAddress">
                      ...
                      <el-input v-if="edit" style="width: 100%;" class="filter-item" placeholder="联系地址"
                                v-model="student.contactAddress"></el-input>
                ...
                <el-col :span="12">
                  ...
                  <el-row>
                    <el-form-item prop="mobile">
                      ...
                      <el-input v-if="edit" style="width: 100%;" class="filter-item" placeholder="联系电话" :maxlength="11"
                                v-model.number="student.mobile"></el-input>
                  ...
                  <el-row>
                    <el-form-item prop="wechat">
                      ...
                      <el-input v-if="edit" style="width: 100%;" class="filter-item" placeholder="微信"
                                v-model="student.wechat"></el-input>
                  ...
                  <el-row>
                    <el-form-item prop="email">
                      ...
                      <el-input v-if="edit" style="width: 100%;" class="filter-item" placeholder="电子邮箱"
                  ...
                  <el-row>
                    <el-form-item prop="company">
                      ...
                      <el-input v-if="edit" style="width: 100%;" class="filter-item" placeholder="所属单位"
                                v-model="student.company"></el-input>
                  ...
                  <el-row>
                    <el-form-item prop="position">
                      ...
                      <el-input v-if="edit" style="width: 100%;" class="filter-item" placeholder="所属职位"
                                v-model="student.position"></el-input>
                ...
                <el-col :span="12">
                  ...
                  <el-row>
                    <el-form-item prop="enrolTime">
                      ...
                      <el-date-picker value-format="timestamp" v-if="edit" type="date" placeholder="入学日期"
                                      style="width: 100%" v-model="student.enrolTime"></el-date-picker>
                  ...
                  <el-row>
                    <el-form-item prop="campus">
                      ...
                      <dict v-if="edit" dictType="dict_campus" v-model="student.campus" style="width: 100%;"
                            placeholder="培训校区"></dict>
                  ...
                  <el-row>
                    <el-form-item prop="periods">
                      ...
                      <el-input v-if="edit" style="width: 100%;" class="filter-item" placeholder="入学期数"
                                v-model="student.periods"></el-input>
                  ...
                  <el-row>
                    <el-form-item prop="source">
                      ...
                      <dict v-if="edit" dictType="dict_source" v-model="student.source" style="width: 100%;"
                            placeholder="来源渠道"></dict>
                  ...
                  <el-row>
                    <el-form-item prop="physicalExamination">
                      ...
                      <div style="padding-left: 16px;font-size: 12px;" v-else>{{student.physicalExamination ===
                        "1"?"是":"否"}}
                      </div>
                    </el-form-item>
                  </el-row>
                  ...
                  <el-row>
                    <el-form-item prop="remark">
                      ...
                      <el-input v-if="edit" type="textarea" v-model="student.remark"
                                :autosize="{ minRows: 2, maxRows: 4}" placeholder="备注"></el-input>
                  ...
                  <el-row>
                    <el-form-item prop="remark">
                      ...
                      <div style="padding-left: 16px;font-size: 12px;">{{student.updateTime | subTime('{y}-{m}-{d}{h}:{i}:{s}')}}
                      </div>
                    </el-form-item>
                  </el-row>
                </el-col>
                <el-col :span="12">
                  ...
                  <el-row>
                    <el-form-item prop="motorcycleType">
                      ...
                      <el-select v-if="edit" style="width: 100%" size="mini" v-model="student.motorcycleType" clearable
                                 placeholder="车型">
                        <el-option
                          v-for="item in $store.state.app.motorcycleType"
                          :key="item"
                  ...
                  <el-row>
                    <el-form-item prop="serviceType">
                      ...
                      <el-select v-if="edit" style="width: 100%" size="mini" v-model="student.serviceType" clearable
                                 placeholder="练车类型">
                        <el-option
                      ...
                      <div style="padding-left: 16px;font-size: 12px;" v-else>{{student.serviceType |
                        serviceTypeFilter}}
                      </div>
                    </el-form-item>
                  </el-row>
                  ...
                  <el-row>
                    <el-form-item prop="enrolSite">
                      ...
                      <dict v-if="edit" v-model="student.enrolSite" dictType="dict_enrolSite" style="width: 100%;"
                            placeholder="入学校区"></dict>
                  ...
                  <el-row>
                    <el-form-item prop="fieldName">
                      ...
                      <Coach v-show="edit" v-model="student.fieldCoach" coachType="field" style="width: 100%;"
                             placeholder="场训教练" @selectCoach="getFieldCoach"></Coach>
                      <div style="padding-left: 16px;font-size: 12px;" v-show="!edit">{{student.fieldName ===
                        null?"未安排":student.fieldName}}
                      </div>
                    </el-form-item>
                  </el-row>
                  <!-- 路训教练 -->
                  <el-row>
                    <el-form-item prop="roadName">
                      ...
                      <Coach v-show="edit" v-model="student.roadCoach" coachType="road" style="width: 100%;"
                             placeholder="路训教练" @selectCoach="getRoadCoach"></Coach>
                      <div style="padding-left: 16px;font-size: 12px;" v-show="!edit">{{student.roadName ===
                        null?"未安排":student.roadName}}
                      </div>
                    </el-form-item>
                  </el-row>
                  <!-- 是否增驾 -->
                  ...
                  <el-row style="margin: 0 10px">
                    <el-form-item prop="introducerId" >
                      ...
                      <div style="padding-left: 16px;font-size: 12px;" v-show="!edit">
                        <span v-for="(introducerName,index) in student.introducerNameList">{{introducerName}}<span
                          v-if="student.introducerNameList.length !== (student+1)">、</span></span>
                      </div>
                    </el-form-item>
                  </el-row>
                  <el-row style="margin: 0 10px">
            ...
            <el-card body-style="padding: 10px 20px;" shadow="never" style="min-height:50px; border-radius:0 0 4px 0;">
              <div v-if="edit" style="float: right;">
                <el-button type="info" size="mini" @click="cancel('student')"><i class="el-icon-fa-undo"></i> 取 消
                </el-button>
                <el-button type="success" size="mini" :loading="btnLoading" @click="update('student')"><i
                  class="el-icon-fa-save"></i> 保 存
                </el-button>
              </div>
              <div v-if="!edit" style="float: left;">
                <el-button type="danger" size="mini" @click="outSchool" v-if="permissions.stu_student_update"
                           icon="el-icon-edit">退 学
                </el-button>
              </div>
              <div v-if="!edit" style="float: right;margin-bottom: 10px;margin-left: 15px;">
                <el-tooltip class="item" effect="dark" content="监管查询新学员是否可以约考" placement="top">
                  <el-button type="primary" size="mini" @click="supervisePushData('2')" v-if="permissions.stu_push_122"
                             :loading="btnLoading2" icon="el-icon-search">新学员
                  </el-button>
                </el-tooltip>
                <el-tooltip class="item" effect="dark" content="监管查询老学员是否可以约考" placement="top">
                  <el-button type="primary" size="mini" @click="supervisePushData('1')" v-if="permissions.stu_push_122"
                             :loading="btnLoading1" icon="el-icon-search">老学员
                  </el-button>
                </el-tooltip>
                <el-button type="primary" v-show="student.physicalExamination==='1'" v-if="permissions.stu_push_122"
                           size="mini" @click="dialog122" icon="el-icon-fa-bars">录入122
                </el-button>
                <el-button type="primary" size="mini" @click="openService" v-if="permissions.stu_service_charge_add"
                           icon="el-icon-fa-money">收 费
                </el-button>
              </div>
              <div v-if="!edit" style="float: right;margin-bottom: 10px;">
                ...
                <el-button type="primary" size="mini" @click="handleBespeakCar" v-if="permissions.stu_bespeak_car_add"
                           icon="el-icon-fa-car">约 车
                </el-button>
                <el-button type="primary" size="mini" @click="handleBespeakExam" v-if="permissions.stu_bespeak_exam_add"
                           icon="el-icon-fa-book">约 考
                </el-button>
                <el-button type="primary" size="mini" @click="editInfo" v-if="permissions.stu_student_update"
        ...
        <el-col :span="area[1] === 600?24:12" style="padding-bottom: 50px;">
          <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                ...
                <el-table-column align="left" label="单号" width="150">
                  <template slot-scope="scope">
                    <a href="javascript:void(0) "
                       ...
                       @click="openService(scope.row)">{{scope.row.serialPrefix}}{{scope.row.paytime |
                      parseTime("{y}{m}")}}{{scope.row.serialNumber | parseSerial}}</a>
                  </template>
                </el-table-column>
            ...
            <el-tab-pane label="来访跟进信息" name="4">
              <div style="line-height: 160px;height: 160px;color: #909399;text-align: center;font-size: 14px"
                   v-if="followUpList.length === 0">
                无跟进信息
              </div>
              <div v-else :style="{height: (client.height-175) + 'px'}"
                   style="width: 100%;overflow: auto;margin-bottom: 10px;padding: 35px">
                <div style="border-left: 2px solid #9fcfff;min-height: 100px;padding-bottom: 25px;"
                     v-for="followUp in followUpList">
                  <el-tag
                    style="float:left;width:50px; height: 50px; border-radius: 1000px;margin-left: -26px;margin-top: -15px; padding: 0;overflow: hidden;">
                  ...
                  <div style="float:right;color:#495060;font-size: 14px;">{{followUp.createTime |
                    subTime("dateTime")}}
                  </div>
                  <div style="clear: both;white-space:normal;width: 100%">
                    <p style="font-size: 14px;margin-left: 35px;border-radius: 10px;white-space:normal;width:80%;">
                      {{followUp.content}}</p>
                  </div>
                </div>
              </div>
            ...
            <el-tab-pane label="课时信息" name="6">
              <el-table :data="courseList" stripe style="width: 100%">
                ...
                <el-table-column align="center" label="需补学时">
                  <template slot-scope="scope">
                    <span
                      :class="scope.row.needfultime > 0?'red':'green'">{{ scope.row.needfultime | periodFilter}}</span>
                  </template>
                </el-table-column>
      ...
      <div v-loading="createLoading" element-loading-text="努力加载中..." style="line-height: 50px;">
        <el-form :model="studentEntity" :rules="studentEntityRules" ref="studentEntity" label-width="80px" size="mini">
          <el-row :gutter="20">
            <el-col :span="12">
              ...
              <el-row>
                <el-form-item prop="mobile">
                  <span slot="label" class="text_css">联系电话</span>
                  <el-input size="mini" class="filter-item" @keyup.enter.native="matchingStudents"
                            @blur="matchingStudents" placeholder="联系电话" :maxlength="11"
                            v-model.number="studentEntity.mobile"></el-input>
                </el-form-item>
              ...
              <el-row>
                <el-form-item prop="idType">
                  <span slot="label" class="text_css">证件类型</span>
                  <el-radio-group v-model="studentEntity.idType">
                    <el-radio label="1">大陆身份证</el-radio>
                    <el-radio label="2">港澳台身份证</el-radio>
              ...
              <el-row>
                <el-form-item prop="idNumber">
                  <span slot="label" class="text_css">证件号码</span>
                  <el-input size="mini" class="filter-item" placeholder="身份证号" :maxlength="18"
                            @keyup.enter.native="AddGenerateInfo" @blur="AddGenerateInfo"
                            v-model="studentEntity.idNumber"></el-input>
                </el-form-item>
              </el-row>
              ...
              <el-row>
                <el-form-item prop="archivesNumber">
                  <span slot="label" class="text_css">档案号</span>
                  <el-input size="mini" class="filter-item" placeholder="档案号"
                            v-model="studentEntity.archivesNumber"></el-input>
                </el-form-item>
              </el-row>
              ...
              <el-row>
                ...
                <el-form-item prop="name">
                  <span slot="label" class="text_css">姓名</span>
                  <el-input size="mini" class="filter-item" placeholder="姓名" clearable
                            v-model="studentEntity.name"></el-input>
                </el-form-item>
              ...
              <el-row>
                <el-form-item prop="campus">
                  <span slot="label" class="text_css">培训校区</span>
                  <dict size="mini" v-model="studentEntity.campus" dictType="dict_campus" style="width: 100%;"
                        placeholder="培训校区"></dict>
                </el-form-item>
              </el-row>
              ...
              <el-row>
                <el-form-item prop="contactAddress">
                  <span slot="label" class="text_css">联系地址</span>
                  <el-input size="mini" class="filter-item" placeholder="联系地址"
                            v-model="studentEntity.contactAddress"></el-input>
                </el-form-item>
              </el-row>
              ...
              <el-row>
                <el-form-item prop="periods">
                  <span slot="label" class="text_css">入学期数</span>
                  <el-input size="mini" class="filter-item" placeholder="入学期数"
                            v-model="studentEntity.periods"></el-input>
                </el-form-item>
              </el-row>
              ...
              <el-row>
                <el-form-item prop="birthday">
                  <span slot="label" class="text_css">生日</span>
                  <el-date-picker size="mini" value-format="timestamp" type="date" placeholder="生日" style="width: 100%"
                                  v-model="studentEntity.birthday"></el-date-picker>
                </el-form-item>
              </el-row>
              ...
              <el-row>
                <el-form-item prop="motorcycleType">
                  <span slot="label" class="text_css">所学车型</span>
                  <el-select v-if="edit" style="width: 100%" size="mini" v-model="studentEntity.motorcycleType"
                             clearable placeholder="车型">
                    <el-option
                      v-for="item in $store.state.app.motorcycleType"
                      :key="item"
                      :label="item"
              ...
              <el-row>
                <el-form-item prop="serviceType">
                  <span slot="label" class="text_css">练车类型:</span>
                  <el-select v-if="edit" style="width: 100%" size="mini" v-model="studentEntity.serviceType" clearable
                             placeholder="练车类型">
                    <el-option
                      v-for="item in $store.state.app.vehicleType"
                      :key="item.value"
              ...
              <el-row>
                <el-form-item prop="source">
                  <span slot="label" class="text_css">来源渠道</span>
                  <dict size="mini" v-model="studentEntity.source" dictType="dict_source" style="width: 100%;"
                        placeholder="来源渠道"></dict>
                </el-form-item>
              </el-row>
              ...
              <el-row>
                <el-form-item prop="enrolTime">
                  <span slot="label" class="text_css">入学日期</span>
                  <el-date-picker size="mini" value-format="timestamp" type="date" placeholder="入学日期"
                                  style="width: 100%" v-model="studentEntity.enrolTime"></el-date-picker>
                </el-form-item>
              </el-row>
            ...
            <el-col :span="12">
              ...
              <el-row>
                ...
                <el-col :span="18">
                  <div style="height: 150px;width: 100px;margin: 0 auto">
                    <el-upload :disabled="!edit" class="AddAvatar-uploader" action="/oss/upload" name="file"
              ...
              <el-row>
                <el-form-item prop="email">
                  <span slot="label" class="text_css">电子邮箱</span>
                  <el-input style="width: 100%;" class="filter-item" placeholder="电子邮箱"
                            v-model="studentEntity.email"></el-input>
                </el-form-item>
              </el-row>
              ...
              <el-row>
                <el-form-item prop="company">
                  ...
                  <el-input style="width: 100%;" class="filter-item" placeholder="所在单位"
                            v-model="studentEntity.company"></el-input>
                </el-form-item>
              ...
              <el-row>
                <el-form-item prop="position">
                  <span slot="label" class="text_css">所属职位</span>
                  <el-input style="width: 100%;" class="filter-item" placeholder="所属职位"
                            v-model="studentEntity.position"></el-input>
                </el-form-item>
              </el-row>
              <!-- 报名点 -->
              <el-row>
                <el-form-item prop="enrolSite">
                  <span slot="label" class="text_css">入学校区</span>
                  <dict v-model="studentEntity.enrolSite" dictType="dict_enrolSite" style="width: 100%;"
                        placeholder="入学校区"></dict>
                </el-form-item>
              </el-row>
          ...
          <el-row :gutter="20">
            <el-form-item prop="remark">
              <span slot="label" class="text_css">备注</span>
              <el-input type="textarea" v-model="studentEntity.remark" :autosize="{ minRows: 4, maxRows: 4}"
    ...
    <el-dialog :modal="false" @close="closeBespeak" title="选择批次" width="550px" :visible.sync="dialogFormBespeak">
      <div :style="{height: ($store.state.app.client.height)/3 +'px'}" style="overflow: auto">
        <div v-if="batchList.length === 0"
             style="width: 100%;text-align: center;font-size: 18px;color: #99a9bf;font-weight: 100;">
          无可预约场次
        </div>
    ...
    <el-dialog :modal="false" @close="closeBespeak" title="选择课时" width="550px" :visible.sync="besCarDialog">
      <div :style="{height: ($store.state.app.client.height)/3 +'px'}" style="overflow: auto">
        <div v-if="carClassList.length === 0"
             style="width: 100%;text-align: center;font-size: 18px;color: #99a9bf;font-weight: 100;">
          无可预约课时
        </div>
    ...
    <el-dialog :modal="false" @close="isPush122 = false;btnLoading = false;$refs['student122'].resetFields()"
               title="录入122" width="800px" :visible.sync="isPush122">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item prop="orgId">
              ...
              <tree-select style="font-size: 12px;" height="28px" url="/upms/org/tree" v-model="student122.orgId"
                           placeholder="部门"></tree-select>
            </el-form-item>
            ...
            <el-form-item prop="SFZMHM">
              <span slot="label" class="text_css">身份证号</span>
              <el-input size="mini" class="filter-item" placeholder="身份证号码"
                        v-model.number="student122.SFZMHM"></el-input>
            </el-form-item>

            <el-form-item prop="CSRQ">
              <span slot="label" class="text_css">出生日期</span>
              <el-date-picker size="mini" value-format="yyyy-MM-dd" type="date" placeholder="生日" style="width: 100%"
                              v-model="student122.CSRQ"></el-date-picker>
            </el-form-item>

            <el-form-item prop="DJZSXXDZ">
              <span slot="label" class="text_css">登记住所</span>
              <el-input size="mini" class="filter-item" placeholder="登记住所"
                        v-model.number="student122.DJZSXXDZ"></el-input>
            </el-form-item>
          ...
          <el-col :span="12">
            ...
            <el-form-item prop="SFZYXQZ">
              ...
              <el-input size="mini" class="filter-item" placeholder="身份证有效期"
                        v-model.number="student122.SFZYXQZ"></el-input>
            </el-form-item>
    ...
    <el-dialog :modal="false" title="监管查询" :close-on-click-modal="false" width="50%" :visible.sync="superviseOpen2"
               :loading="dgLoading">
  ...
  export default {
    ...
    data() {
      var idNumberReg = (rule, value, callback) => {
        /* 台湾 */
        var TaiwanReg = /^[a-zA-Z][0-9]{9}$/;
        /* 香港 */
        var HongKongReg = /^((\s?[A-Za-z])|([A-Za-z]{2}))\d{6}(\([0−9aA]\)|[0-9aA])$/;
        /* 澳门 */
        var MacaoReg = /^[1|5|7][0-9]{6}\([0-9Aa]\)/;
        /* 大陆 */
        ...
        if (userCardReg.test(value) && this.studentEntity.idType == 1) {
          callback();
        } else if (TaiwanReg.test(value) && this.studentEntity.idType == 2) {
          callback();
        } else if (HongKongReg.test(value) && this.studentEntity.idType == 2) {
          callback();
        } else if (MacaoReg.test(value) && this.studentEntity.idType == 2) {
          callback();
        } else if (this.studentEntity.idType == 3) {
          callback();
        } else {
