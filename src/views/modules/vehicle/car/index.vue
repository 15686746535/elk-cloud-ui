            ...
            <el-row>
              ...
              <el-col :span="8">
                ...
                <el-row>
                  ...
                  <el-col :span="16">
                    <el-date-picker value-format="timestamp"  v-if="edit === 'certificate'" type="date" placeholder="行驶证注册登记日期"  style="width: 100%" v-model="car.certificateEntity.drivingLicenseEnroll"></el-date-picker>
                    <span style="padding-left: 16px;font-size: 12px;" v-else>{{car.certificateEntity.drivingLicenseEnroll | subTime}}</span>
                  </el-col>
                </el-row>
              ...
              <el-col :span="8">
                ...
                <el-row>
                  ...
                  <el-col :span="16">
                    <el-date-picker value-format="timestamp"  v-if="edit === 'certificate'" type="date" placeholder="行驶证发证日期"  style="width: 100%" v-model="car.certificateEntity.drivingLicenseRelease"></el-date-picker>
                    <span style="padding-left: 16px;font-size: 12px;" v-else>{{car.certificateEntity.drivingLicenseRelease | subTime}}</span>
                  </el-col>
                </el-row>
              ...
              <el-col :span="8">
                ...
                <el-row>
                  ...
                  <el-col :span="16">
                    <el-date-picker value-format="timestamp"  v-if="edit === 'certificate'" type="date" placeholder="行驶证年审有效期"  style="width: 100%" v-model="car.certificateEntity.drivingLicenseEnd"></el-date-picker>
                    <span style="padding-left: 16px;font-size: 12px;" v-else>{{car.certificateEntity.drivingLicenseEnd | subTime}}</span>
                  </el-col>
                </el-row>
            ...
            <el-row>
              ...
              <el-col :span="8">
                ...
                <el-row>
                  ...
                  <el-col :span="16">
                    <el-date-picker value-format="timestamp"  v-if="edit === 'certificate'" type="date" placeholder="道路运输发证日期"  style="width: 100%" v-model="car.certificateEntity.roadTransportStart"></el-date-picker>
                    <span style="padding-left: 16px;font-size: 12px;" v-else>{{car.certificateEntity.roadTransportStart | subTime}}</span>
                  </el-col>
                </el-row>
              ...
              <el-col :span="8">
                ...
                <el-row>
                  ...
                  <el-col :span="16">
                    <el-date-picker value-format="timestamp"  v-if="edit === 'certificate'" type="date" placeholder="道路运输年审有效期"  style="width: 100%" v-model="car.certificateEntity.roadTransportEnd"></el-date-picker>
                    <span style="padding-left: 16px;font-size: 12px;" v-else>{{car.certificateEntity.roadTransportEnd | subTime}}</span>
                  </el-col>
                </el-row>
            ...
            <el-row>
              ...
              <el-col :span="8">
                ...
                <el-row>
                  ...
                  <el-col :span="16">
                    <el-date-picker value-format="timestamp"  v-if="edit === 'certificate'" type="date" placeholder="标识卡到期日期"  style="width: 100%" v-model="car.certificateEntity.identificationEnd"></el-date-picker>
                    <span style="padding-left: 16px;font-size: 12px;" v-else>{{car.certificateEntity.identificationEnd | subTime}}</span>
                  </el-col>
                </el-row>
              ...
              <el-col :span="8">
                ...
                <el-row>
                  ...
                  <el-col :span="16">
                    <el-date-picker value-format="timestamp"  v-if="edit === 'certificate'" type="date" placeholder="评定日期"  style="width: 100%" v-model="car.certificateEntity.evaluation"></el-date-picker>
                    <span style="padding-left: 16px;font-size: 12px;" v-else>{{car.certificateEntity.evaluation | subTime}}</span>
                  </el-col>
                </el-row>
              ...
              <el-col :span="8">
                ...
                <el-row>
                  ...
                  <el-col :span="16">
                    <el-date-picker value-format="timestamp"  v-if="edit === 'certificate'" type="date" placeholder="强制报销日期"  style="width: 100%" v-model="car.certificateEntity.scrap"></el-date-picker>
                    <span style="padding-left: 16px;font-size: 12px;" v-else>{{car.certificateEntity.scrap | subTime}}</span>
                  </el-col>
                </el-row>
              ...
              <el-col :span="12">
                ...
                <el-row>
                  ...
                  <el-col :span="18">
                    ...
                    <span v-else>
                      <span style="padding-left: 16px;font-size: 12px;" >{{car.certificateEntity.clivtaStart | subTime}}</span>
                      <span style="padding-left: 16px;font-size: 12px;">至</span>
                      <span style="padding-left: 16px;font-size: 12px;" >{{car.certificateEntity.clivtaEnd | subTime}}</span>
                    </span>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  ...
                  <el-col :span="18">
                    ...
                    <span v-else>
                      <span style="padding-left: 16px;font-size: 12px;" >{{car.certificateEntity.maintenanceStart | subTime}}</span>
                      <span style="padding-left: 16px;font-size: 12px;">至</span>
                      <span style="padding-left: 16px;font-size: 12px;" >{{car.certificateEntity.maintenanceEnd | subTime}}</span>
                    </span>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  ...
                  <el-col :span="18">
                    ...
                    <span v-else>
                      <span style="padding-left: 16px;font-size: 12px;" >{{car.certificateEntity.twoDimensionalStart | subTime}}</span>
                      <span style="padding-left: 16px;font-size: 12px;">至</span>
                      <span style="padding-left: 16px;font-size: 12px;" >{{car.certificateEntity.twoDimensionalEnd | subTime}}</span>
                    </span>
                  </el-col>
                </el-row>
              ...
              <el-col :span="12">
                ...
                <el-row>
                  ...
                  <el-col :span="18">
                    ...
                    <span v-else>
                      <span style="padding-left: 16px;font-size: 12px;" >{{car.certificateEntity.viStart | subTime}}</span>
                      <span style="padding-left: 16px;font-size: 12px;">至</span>
                      <span style="padding-left: 16px;font-size: 12px;" >{{car.certificateEntity.viEnd | subTime}}</span>
                    </span>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  ...
                  <el-col :span="18">
                    ...
                    <span v-else>
                      <span style="padding-left: 16px;font-size: 12px;" >{{car.certificateEntity.bottleStart | subTime}}</span>
                      <span style="padding-left: 16px;font-size: 12px;">至</span>
                      <span style="padding-left: 16px;font-size: 12px;" >{{car.certificateEntity.bottleEnd | subTime}}</span>
                    </span>
                  </el-col>
                </el-row>
