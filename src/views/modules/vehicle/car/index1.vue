  ...
  <div class="app-container calendar-list-container" :style="{height: $store.state.app.client.height + 'px'}">
    ...
    <div v-show="showModule=='info'">
      ...
      <el-card body-style="padding:0">
        ...
        <el-form :model="vehicleEntity" :rules="vehicleRules" ref="vehicleEntity" label-position="left" label-width="100px">
                ...
                <el-col style="width: 300px;margin-right: 22px">
                  ...
                  <el-row style="height: 62px;">
                    <el-form-item prop="plateColor">
                      ...
                      <el-input v-if="edit" v-model="vehicleEntity.plateColor"  placeholder="车牌颜色"></el-input>
                  ...
                  <el-row style="height: 62px;">
                    <el-form-item prop="carColor">
                      ...
                      <el-input v-if="edit" v-model="vehicleEntity.carColor" placeholder="车身颜色"></el-input>
                  ...
                  <el-row style="height: 62px;">
                    <el-form-item prop="vehicleEntity.number">
                      ...
                      <el-input v-if="edit"  v-model="vehicleEntity.number" placeholder="自编号"></el-input>
                  ...
                  <el-row :gutter="10" style="height: 62px;">
                    <el-col :span="8">
                      <el-form-item prop="vehicleType">
                        ...
                        <el-input v-if="edit"  v-model="vehicleEntity.vehicleType" placeholder="车辆类别"></el-input>
                    ...
                    <el-col :span="8">
                      <el-form-item prop="vehicleState">
                        ...
                        <el-input v-if="edit" v-model="vehicleEntity.vehicleState" placeholder="车辆来源" ></el-input>
                    ...
                    <el-col :span="8">
                      <el-form-item prop="plateNumber">
                        ...
                        <el-input v-if="edit"  v-model="vehicleEntity.plateNumber" placeholder="车辆牌照"></el-input>
                  ...
                  <el-row :gutter="10" style="height: 62px;">
                    <el-col :span="8">
                      <el-form-item prop="factoryTime">
                        ...
                        <el-date-picker value-format="timestamp" style="width: 100%" v-if="edit" type="date" placeholder="出厂日期" v-model="vehicleEntity.factoryTime"></el-date-picker>
                    ...
                    <el-col :span="8">
                      <el-form-item prop="registerTime">
                        ...
                        <el-date-picker value-format="timestamp" style="width: 100%" v-if="edit" type="date" placeholder="注册登记日期" v-model="vehicleEntity.registerTime"></el-date-picker>
                    ...
                    <el-col :span="8">
                      <el-form-item prop="oldPlateNumber">
                        ...
                        <el-input v-if="edit" v-model="vehicleEntity.oldPlateNumber" placeholder="原车辆牌照"></el-input>
                  ...
                  <el-row :gutter="10" style="height: 62px;">
                    <el-col :span="8">
                      <el-form-item prop="vinNo">
                        ...
                        <el-input v-if="edit" v-model="vehicleEntity.vinNo" placeholder="车架号"></el-input>
                    ...
                    <el-col :span="8">
                      <el-form-item prop="engineNo">
                        ...
                        <el-input v-if="edit" v-model="vehicleEntity.engineNo" placeholder="发动机号"></el-input>
                    ...
                    <el-col :span="8">
                      <el-form-item prop="motorcycleType">
                        ...
                        <el-input v-if="edit" v-model="vehicleEntity.motorcycleType" placeholder="型号"></el-input>
                  ...
                  <el-row :gutter="10" style="height: 62px;">
                    <el-col :span="8">
                      <el-form-item prop="fuelType">
                        ...
                        <el-input v-if="edit" v-model="vehicleEntity.fuelType" placeholder="燃料类别" ></el-input>
                    ...
                    <el-col :span="8">
                      <el-form-item prop="allowNumber">
                        ...
                        <el-input v-if="edit"  v-model="vehicleEntity.allowNumber" placeholder="核定载客人"></el-input>
                    ...
                    <el-col :span="8">
                      <el-form-item prop="brand">
                        ...
                        <el-input v-if="edit" v-model="vehicleEntity.brand" placeholder="厂牌"></el-input>
                  ...
                  <el-row :gutter="10" style="height: 62px;">
                    <el-col :span="8">
                      <el-form-item prop="technicalLevel">
                        ...
                        <el-input v-if="edit"  v-model="vehicleEntity.technicalLevel" placeholder="技术等级"></el-input>
                    ...
                    <el-col :span="8">
                      <el-form-item prop="userId">
                        ...
                        <el-input v-if="edit"  v-model="vehicleEntity.userId" placeholder="使用责任人"></el-input>
                    ...
                    <el-col :span="8">
                      <el-form-item prop="affiliation">
                        ...
                        <el-input v-if="edit"  v-model="vehicleEntity.affiliation" placeholder="所属机构"></el-input>
