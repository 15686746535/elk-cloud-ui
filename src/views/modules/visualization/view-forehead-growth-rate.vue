<template>
  <div class="view-enrolment view-container">
    <el-row class="enrolment-header">
      ...
      <label style="margin-right: 10px">招生金额同比增长率统计</label>
  ...
  export default {
    ...
    data() {
      return {
        ...
        currList:[], // 今年 招生金额 单位万
        lastList:[], // 去年年 招生金额 单位万
        campusList: [
          { name: "壹路校区", id: 1 },
          { name: "华通校区", id: 2 }
        ],
    ...
    methods: {
      sum(list){
        return options._SUM(list);
      },
      getList(){
        let _this=this
        this.currList = [123,322,345,222,125,235,333,123,432,138,111,178];
        this.lastList = [222,125,123,333,322,345,138,111,432,111,235,178];
        // 计算
