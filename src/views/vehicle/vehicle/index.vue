      ...
      <el-card>
        ...
        <el-table :data="list" height="500" border style="width: 100%"  highlight-current-row @row-dblclick="editlist" v-loading="listLoading" element-loading-text="给我一点时间">
          ...
          <el-table-column label="基本信息">
            <template slot-scope="scope">
              <img :src="scope.row.safetyEntity" class="img">  <!-- 车辆图片 -->
      ...
      <el-card  class="box-card1">
        ...
        <el-form :inline="true"  :model="vehicle" label	 label-width="100px" label-position="left" class="demo-form-inline">
          <div style="width: 280px; height: 400px;float: left;">
            <img width="100%" height="100%" :src="vehicle.safetyEntity" class="image">
            <!--<el-button type="primary" style="width: 174px;" @click="edit">修改头像</el-button>-->
            <!-- 车牌颜色 -->


            <el-form-item  label-width="82px" label="车牌颜色:" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.plateColor}}</span>
              <Dict type="dict_sex" v-else  style="width: 100px" v-model="vehicle.vehicleEntity.plateColor" ></Dict>
            </el-form-item>
            <br>
            <el-form-item label-width="82px" label="车身颜色:" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.carColor}}</span>
              <el-input  v-else v-model="vehicle.vehicleEntity.carColor" style="width: 100px" placeholder="车身颜色"></el-input>
            </el-form-item>
          ...
          <el-col :span="6">
            <el-form-item label="自编号:" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.number}}</span>
              <el-input v-else  v-model="vehicle.vehicleEntity.number" style="width: 180px" placeholder="自编号"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="6">
            <el-form-item label="使用责任人" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.name}}</span>
              <el-select v-else v-model="vehicle.vehicleEntity.name" style="width: 180px" placeholder="使用责任人">
          ...
          <el-col :span="6">
            <el-form-item label="所属机构:" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.affiliation}}</span>
              <el-input v-else  v-model="vehicle.vehicleEntity.affiliation" style="width: 180px" placeholder="所属机构"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="6">
            <el-form-item label="车辆牌照:" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.plateNumber}}</span>
              <span v-else >
              <el-input  v-model="vehicle.vehicleEntity.plateNumber" style="width: 180px" placeholder="车辆牌照"></el-input>
          ...
          <el-col :span="6">
            <el-form-item label="原车辆牌照:">
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.oldPlateNumber}}</span>
              <el-input  v-else v-model="vehicle.vehicleEntity.oldPlateNumber" style="width: 180px" placeholder="原车辆牌照"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="6">
            <el-form-item label="车辆来源:" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.vehicleState}}</span>
              <Dict type="dict_sex" v-else  style="width: 180px" v-model="vehicle.vehicleEntity.vehicleState" ></Dict>
              <!--<el-input v-else  v-model="vehicle.mobile" placeholder="车辆来源"  style="width: 180px"></el-input>-->
            </el-form-item>
          </el-col>
          ...
          <el-col :span="6">
            <el-form-item label="发动机号:" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.engineNo}}</span>
              <el-input v-else  v-model="vehicle.vehicleEntity.engineNo" placeholder="发动机号"  style="width: 180px"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="10">
            <el-form-item label="车架号:" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.vinNo}}</span>
              <el-input v-else  v-model="vehicle.vehicleEntity.vinNo" placeholder="车架号"  style="width: 180px"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="6">
            <el-form-item label="车辆类别:" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.vehicleType}}</span>
              <Dict type="dict_sex" v-else  style="width: 180px" v-model="vehicle.vehicleEntity.vehicleType" ></Dict>
              <!--<el-input v-else  v-model="vehicle.mobile" placeholder="车辆来源"  style="width: 180px"></el-input>-->
            </el-form-item>
          </el-col>
          ...
          <el-col :span="6">
            <el-form-item label="出厂日期:" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.factoryTime }}</span>
              <el-date-picker  v-else type="date" placeholder="出厂日期"  style="width: 180px" v-model="vehicle.joinedTime"></el-date-picker>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="6">
            <el-form-item label="注册日期:" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.registerTime }}</span>
              <el-date-picker  v-else type="date" placeholder="注册登记日期"  style="width: 180px" v-model="vehicle.joinedTime"></el-date-picker>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="6">
            <el-form-item label="技术等级:">
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.technicalLevel}}</span>
              <el-input v-else  v-model="vehicle.vehicleEntity.technicalLevel" placeholder="技术等级"  style="width: 180px"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="6">
            <el-form-item label="核定载客人:" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.allowNumber}}</span>
              <el-input v-else  v-model="vehicle.vehicleEntity.allowNumber" placeholder="核定载客人"  style="width: 180px"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="6">
            <el-form-item label="燃料类别:">
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.fuelType}}</span>
              <Dict type="dict_sex" v-else  style="width: 180px" v-model="vehicle.vehicleEntity.fuelType" ></Dict>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="6">
            <el-form-item label="型号:" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.motorcycleType}}</span>
              <el-input v-else  v-model="vehicle.vehicleEntity.motorcycleType" placeholder="型号"  style="width: 180px"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="6">
            <el-form-item label="厂牌:" required>
              <span style="padding-left: 16px;font-size: 12px;" v-if="!edit">{{vehicle.vehicleEntity.brand}}</span>
              <el-input v-else v-model="vehicle.vehicleEntity.brand" placeholder="厂牌"  style="width: 180px"></el-input>
            </el-form-item>
          </el-col>
      ...
      <el-card class="box-card2">
        ...
        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
          ...
          <el-tab-pane label="证件信息" name="1">
            ...
            <el-table :data="vehicle.certificateEntity" stripe style="width: 100%">
